...
namespace UI.Main
{
            ...
            Lessons1 = new List<Lesson>()
    {
        ...
        private void InitDrinks()
        {
            ...
            {
                new Drink("Margarita", new List<string> { "2 ounces tequila", "1 ounce lime juice", "1/2 ounce orange liqueur (optional)", "Salt for rim (optional)" }, "Images/Images/Margarita", "Images/Images/Margarita", new List<string>()),
                new Drink("Old Fashioned", new List<string> { "2 ounces bourbon or rye whiskey", "1/2 ounce sugar syrup", "2 dashes Angostura bitters", "Orange peel for garnish (optional)" }, "Images/Images/Old Fashioned", "Images/Images/Old Fashioned", new List<string>()),
                ...
                new Drink("Mojito", new List<string> { "2 ounces white rum", "1 ounce lime juice", "1/2 ounce simple syrup", "6 mint leaves", "Soda water", "Lime wedge for garnish" }, "Images/Images/Mojito", "Images/Images/Mojito", new List<string>()),
                new Drink("Negroni", new List<string> { "1 ounce gin", "1 ounce Campari", "1 ounce sweet vermouth", "Orange peel for garnish (optional)" }, "Images/Images/Negroni", "Images/Images/Negroni", new List<string>()),
                new Drink("Espresso Martini", new List<string> { "1.5 ounces vodka", "1 ounce espresso", "1/2 ounce coffee liqueur", "3 coffee beans for garnish" }, "Images/Images/Espresso Martini", "Images/Images/Espresso Martini", new List<string>()),
                new Drink("Aperol Spritz", new List<string> { "3 ounces Aperol", "2 ounces prosecco", "1 ounce soda water", "Orange slice for garnish" }, "Images/Images/Aperol Spritz", "Images/Images/Aperol Spritz", new List<string>()),
                new Drink("French 75", new List<string> { "2 ounces gin", "1/2 ounce lemon juice", "1/2 ounce simple syrup", "Champagne", "Lemon peel for garnish" }, "Images/Images/French 75", "Images/Images/French 75", new List<string>()),
                ...
                new Drink("Aviation", new List<string> { "2 ounces gin", "1/2 ounce lemon juice", "1/4 ounce maraschino liqueur", "1/4 ounce crème de violette", "Cherry for garnish" }, "Images/Images/Aviation", "Images/Images/Aviation", new List<string>()),
                new Drink("Pina Colada", new List<string> { "2 ounces light rum", "1 ounce coconut cream", "1 ounce pineapple juice", "Pineapple wedge and cherry for garnish" }, "Images/Images/Pina Colada", "Images/Images/Pina Colada", new List<string>()),
                new Drink("Chi Chi", new List<string> { "1 ounce vodka", "1 ounce maraschino liqueur", "1 ounce pineapple juice", "Milk", "Cherry for garnish" }, "Images/Images/Chi Chi", "Images/Images/Chi Chi", new List<string>()),
                new Drink("Mai Tai", new List<string> { "2 ounces light rum", "1 ounce orgeat liqueur", "1 ounce almond syrup", "1 ounce lime juice", "Pineapple wedge and cherry for garnish" }, "Images/Images/Mai Tai", "Images/Images/Mai Tai", new List<string>()),
                new Drink("Zombie", new List<string> { "2 ounces light rum", "1 ounce dark rum", "1 ounce rum liqueur", "1 ounce pineapple juice", "1 ounce orange juice", "1 ounce lime juice", "1/2 ounce grapefruit juice", "Pineapple wedge and cherry for garnish" }, "Images/Images/Zombie", "Images/Images/Zombie", new List<string>()),
                new Drink("Cosmopolitan", new List<string> { "1 1/2 ounces vodka", "1/2 ounce Cointreau", "1/2 ounce cranberry juice", "1/2 ounce lime juice", "Lemon twist for garnish" }, "Images/Images/Cosmopolitan", "Images/Images/Cosmopolitan", new List<string>()),
                new Drink("Moscow Mule", new List<string> { "2 ounces vodka", "1/2 ounce lime juice", "4 ounces ginger beer", "Lime wedge for garnish" }, "Images/Images/Moscow Mule", "Images/Images/Moscow Mule", new List<string>()),
                new Drink("Greyhound", new List<string> { "2 ounces vodka", "4 ounces grapefruit juice", "Lemon twist for garnish" }, "Images/Images/Greyhound", "Images/Images/Greyhound", new List<string>()),
                new Drink("Vodka Martini", new List<string> { "2 ounces vodka", "1/2 ounce dry vermouth", "Olive for garnish" }, "Images/Images/Vodka Martini", "Images/Images/Vodka Martini", new List<string>()),
                new Drink("Irish Coffee", new List<string> { "2 ounces Irish whiskey", "1/2 ounce sugar syrup", "Hot coffee", "Whipped cream for garnish" }, "Images/Images/Irish Coffee", "Images/Images/Irish Coffee", new List<string>()),
                new Drink("French Connection", new List<string> { "1/2 ounce cognac", "1/2 ounce Amaretto", "Orange twist for garnish" }, "Images/Images/French Connection", "Images/Images/French Connection", new List<string>()),
                new Drink("B-52", new List<string> { "1/3 ounce Kahlúa", "1/3 ounce Baileys Irish Cream", "1/3 ounce Grand Marnier", "Coffee bean for garnish" }, "Images/Images/B-52", "Images/Images/B-52", new List<string>()),
            };
            ...
            DrinksInMl = new List<Drink>
            {
                ...
                new Drink("Old Fashioned", new List<string> { "2 ounces bourbon or rye whiskey", "1/2 ounce sugar syrup", "2 dashes Angostura bitters", "Orange peel for garnish (optional)" }, "Images/Images/OldFashioned", "Images/Images/OldFashioned", new List<string>()),
                new Drink("Daiquiri", new List<string> { "2 ounces white rum", "1 ounce lime juice", "1/2 ounce simple syrup" }, "", "Images/Images/Daiquiri", new List<string>()),
                ...
                new Drink("Penicillin", new List<string> { "2 ounces blended Scotch whisky", "1/2 ounce lemon juice", "1/2 ounce honey syrup", "1/4 ounce ginger syrup", "Smoked peat garnish (optional)" }, "Images/Images/Penicillin", "Images/Images/Penicillin", new List<string>()),
                ...
                new Drink("Pina Colada", new List<string> { "2 ounces light rum", "1 ounce coconut cream", "1 ounce pineapple juice", "Pineapple wedge and cherry for garnish" }, "Images/Images/PinaColada", "Images/Images/PinaColada", new List<string>()),
        ...
        private void InitPages()
        {
            ...
            _sideMenuPage = new SideMenuPage(_sideMenuView, _header, "", _homePage, _shoppingListPage, _aboutUsPage, _toolsOtherPage, _settingsPage);
